            ...
            if y_indices.size > 0 and x_indices.size > 0:
                ...
                if object_width > size or object_height > size:
                    if object_width >= object_height:
                        ...
                        print(f'Object {object_counter}. Detected vertically aligned cropped image detected larger than {size} pixels, adjusted to width: {calculate_width} and height {size}.')
                else:
